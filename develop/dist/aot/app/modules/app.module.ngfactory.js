...
var AppModuleInjector = (function (_super) {
    ...
    function AppModuleInjector(parent) {
        _super.call(this, parent, [import30.ExplorationViewerNgFactory], [import30.ExplorationViewerNgFactory]);
    }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_19", {
        get: function () {
            if ((this.__EventManager_19 == null)) {
                (this.__EventManager_19 = new import14.EventManager(this._EVENT_MANAGER_PLUGINS_18, this.parent.get(import34.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_DataService_38", {
        get: function () {
            if ((this.__DataService_38 == null)) {
                (this.__DataService_38 = new import25.DataService(this._Http_37));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_DateService_39", {
        get: function () {
            if ((this.__DateService_39 == null)) {
                (this.__DateService_39 = new import26.DateService(this._Http_37));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_QuantileService_40", {
        get: function () {
            if ((this.__QuantileService_40 == null)) {
                (this.__QuantileService_40 = new import27.QuantileService());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ColoringService_41", {
        get: function () {
            if ((this.__ColoringService_41 == null)) {
                (this.__ColoringService_41 = new import28.ColoringService());
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ApplicationRef__12 = new import11.ApplicationRef_(this.parent.get(import34.NgZone), this.parent.get(import36.Console), this, this._ErrorHandler_9, this, this._ApplicationInitStatus_10, this.parent.get(import10.TestabilityRegistry, null), this._Testability_11);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import38.ErrorHandler)) {
        ...
        if ((token === import45.XSRFStrategy)) {
        ...
        if ((token === import46.Http)) {
            return this._Http_37;
        }
        if ((token === import25.DataService)) {
            return this._DataService_38;
        }
        if ((token === import26.DateService)) {
            return this._DateService_39;
        }
        if ((token === import27.QuantileService)) {
            return this._QuantileService_40;
        }
        if ((token === import28.ColoringService)) {
            return this._ColoringService_41;
        }
